...
import com.vanenburgdemo.exapp.base.model.constants.NtabConstantBase;
...
@Component
public abstract class NtabPerimeterBaseImpl<T extends NtabBase> implements IPerimeterManager<T>, NtabConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(NtabPerimeterBaseImpl.class);
