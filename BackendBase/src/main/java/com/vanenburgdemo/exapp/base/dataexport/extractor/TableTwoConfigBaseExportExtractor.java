...
public class TableTwoConfigBaseExportExtractor<SERVICE extends TableTwoConfigBaseAnalyticalExtractorService<M>,M extends TableTwoConfigAnalyticalBase> extends ExportExtractor<RappitExport> {

	private Logger LOGGER = LoggerFactory.getLogger(TableTwoConfigBaseExportExtractor.class);

	protected SERVICE logic;
	
	public TableTwoConfigBaseExportExtractor(boolean isChunk, SERVICE logic) {
		super(isChunk);
		this.logic = logic;
	}
