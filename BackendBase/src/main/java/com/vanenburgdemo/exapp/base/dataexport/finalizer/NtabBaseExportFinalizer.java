...
public class NtabBaseExportFinalizer extends ExportFinalizer<RappitExport> {
	
	private ApplicationUserBaseService  applicationUserBaseService;
	public NtabBaseExportFinalizer(ApplicationUserBaseService applicationUserBaseService, boolean isChunk) {
		super(isChunk);
