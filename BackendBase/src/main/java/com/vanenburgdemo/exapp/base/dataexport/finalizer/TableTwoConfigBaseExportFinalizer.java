...
public class TableTwoConfigBaseExportFinalizer extends ExportFinalizer<RappitExport> {
	
	private ApplicationUserBaseService  applicationUserBaseService;
	public TableTwoConfigBaseExportFinalizer(ApplicationUserBaseService applicationUserBaseService, boolean isChunk) {
		super(isChunk);
