...
public class TableOneConfgBaseExportFinalizer extends ExportFinalizer<RappitExport> {
	
	private ApplicationUserBaseService  applicationUserBaseService;
	public TableOneConfgBaseExportFinalizer(ApplicationUserBaseService applicationUserBaseService, boolean isChunk) {
		super(isChunk);
