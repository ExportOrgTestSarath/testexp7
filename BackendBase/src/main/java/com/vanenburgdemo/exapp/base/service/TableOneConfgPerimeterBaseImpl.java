...
import com.vanenburgdemo.exapp.base.model.constants.TableOneConfgConstantBase;
...
@Component
public abstract class TableOneConfgPerimeterBaseImpl<T extends TableOneConfgBase> implements IPerimeterManager<T>, TableOneConfgConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(TableOneConfgPerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, VALUE1, VALUE2};
