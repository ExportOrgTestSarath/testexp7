...
import com.vanenburgdemo.exapp.base.model.constants.TableTwoConfigConstantBase;
...
@Component
public abstract class TableTwoConfigPerimeterBaseImpl<T extends TableTwoConfigBase> implements IPerimeterManager<T>, TableTwoConfigConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(TableTwoConfigPerimeterBaseImpl.class);
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase == null) {
			...
			String[] readFields = new String[] {SID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, SYNC_TIME, EMBED, TRIBBER};
